...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Train a CSI activity-recognition model from scratch.')
    ...
    parser.add_argument('--model-dir', default='models', help='Directory to save the trained model')
